...
Law and adjuncts for this site. Not a second brand system.

| Path | Role |
|---|---|
| `sources/` | The two immutable specs |
| `CONFLICTS.md` | Precedence when they disagree |
| `voice.md` | Copy register |
